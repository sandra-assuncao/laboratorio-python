...
* **Ambiente de Desenvolvimento:** VS Code (Visual Studio Code), PyCharm & Google Colab (Jupyter Notebooks)
* **Análise e Tratamento de Dados:** Pandas, Plotly Express, pdfplumber
* **Controle de Versão:** Git & GitHub
* **Domínio de Negócio:** Análise de Dados, Finanças, Tesouraria, Contas a Pagar/Receber, Cash Management e Validação de Dados
